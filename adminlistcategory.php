...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="admincategory.php">Nueva carrera</a></li>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de carreras</h2>
            <div class="div-table">
          ...
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../process/UpdateCategory.php" method="post" data-type-form="update" autocomplete="off">
              <div class="modal-header">
                ...
                <h4 class="modal-title text-center all-tittles">Actualizar datos de carrera</h4>
              </div>
