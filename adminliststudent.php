        ...
        <div class="container-fluid" style="margin: 0 0 50px 0;">
            <form class="pull-right" style="width: 30% !important;" action="adminliststudent.php" method="get" autocomplete="off">
                <div class="group-material">
                    <input type="search" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar estudiante" name="StudentN" required="" data-toggle="tooltip" data-placement="top" title="Escribe los nombres, apellidos o NIE del estudiante">
            ...
            <?php
                    ...
                    echo '<div class="table-responsive">
                        <div class="div-table" style="margin:0 !important;">
                            <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                                ...
                                <div class="div-table-cell" style="width: 17%;">NIE</div>
                ...
                if(!$StudentN==""){
                    ...
                    if(mysqli_num_rows($selectStudentByName)>0){
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSN['NIE'].'</div>
                        ...
                        echo '<br><br><br><h3 class="text-center all-tittles">No existe ningún estudiante registrado con los nombres, apellidos o NIE "'.$StudentN.'"</h3><br><br>';
                    }
                            ...
                            echo '<li>
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            <div class="div-table-cell" style="width: 6%;">'.$c.'</div>
                                            <div class="div-table-cell" style="width: 17%;">'.$dataSS['NIE'].'</div>
